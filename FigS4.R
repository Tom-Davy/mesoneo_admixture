...
tiff(filename="davyetal2022_figS4.tiff", res = 150, units="in", width = 14, height = 7, compression="lzw") 
LAcol<-colorRampPalette(colors = c('#e40959','grey','#412ca8'))
...
tiff(filename="davyetal2022_S4.tiff",  units="in", width=8, height=8, res=150, compression = "lzw")
...
legend(x="topleft", legend=c("Proximal to HLA-E","Proximal to SLC24A5","Proximal to IQCJ","Proximal to DNM1L"),  col=c(col.IBM[1:5]), pch=c(20))
